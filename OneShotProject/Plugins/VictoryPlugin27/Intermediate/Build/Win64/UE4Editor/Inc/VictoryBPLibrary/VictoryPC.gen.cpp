...
static struct FScriptStruct_VictoryBPLibrary_StaticRegisterNativesFVictorySubtitleCue
{
	...
	{
		UScriptStruct::DeferCppStructOps<FVictorySubtitleCue>(FName(TEXT("VictorySubtitleCue")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FVictorySubtitleCue_Hash() { return 3893520923U; }
	DEFINE_FUNCTION(AVictoryPC::execVictoryPC_GetMyIP_SendRequest)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(AVictoryPC::execSubtitles_CPPDelegate)
	{
		P_GET_TARRAY_REF(FSubtitleCue,Z_Param_Out_VictorySubtitles);
		P_GET_PROPERTY(FFloatProperty,Z_Param_CueDuration);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->Subtitles_CPPDelegate(Z_Param_Out_VictorySubtitles,Z_Param_CueDuration);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(AVictoryPC::execVictoryPlaySpeechSound)
	{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AVictoryPC_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AVictoryPC_OnVictorySubtitlesQueued, "OnVictorySubtitlesQueued" }, // 1608795097
		{ &Z_Construct_UFunction_AVictoryPC_Subtitles_CPPDelegate, "Subtitles_CPPDelegate" }, // 793258498
		...
		{ &Z_Construct_UFunction_AVictoryPC_VictoryPlaySpeechSound, "VictoryPlaySpeechSound" }, // 2635335912
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AVictoryPC, 2171234533);
